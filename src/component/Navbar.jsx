        ...
        <div className="px-4 md:px-30 py-5 bg-black bg-cover text-white z-10 relative min-h-[70vh] md:min-h-[80vh] flex items-center">
            ...
            <div className="relative z-10 w-full">
                <div className="flex justify-between items-center mb-8 md:mb-0">
                    <div>
                        <img className="h-10" src={netflixLogo} alt="" />
                    </div>

                    <div className="flex items-center gap-2 md:gap-0">
                        <div>
                            <select className="pr-8 md:pr-12 border p-1 md:mr-2 border-gray-500 bg-transparent text-sm md:text-base" name="" id="">
                                <option className="text-black" value="English">English</option>
                                <option className="text-black" value="Arabic">Arabic</option>
                            </select>
                        </div>
                        <button className="bg-red-600 px-3 md:px-5 py-1 rounded text-sm md:text-base">Sign In</button>
                    </div>
                </div>
                ...
                <div className="py-10 md:py-30 flex flex-col items-center text-center">
                    ...
                    <p className="text-base md:text-lg mb-4 md:mb-0">Ready to watch? Enter your email to create or restart your membership.</p>
                    <div className="py-3 md:py-5 flex flex-col md:flex-row gap-3 md:gap-0 w-full max-w-2xl">
                        ...
                        />
                        <button className="bg-red-600 p-3 md:p-4 rounded font-bold text-lg md:text-xl whitespace-nowrap">
                            Get Started
                        </button>
                    </div>
                </div>
